	...
	$(document).ready(function() {
		...
		$(".delete").click(function() {
			$.ajax({
				...
				data : {
					userid : $("#adminMemberInfo #myId").text()
				}
			});
			$("#adminWithdraw").modal();
		});
...
<body>
	...
	<div class="container" style="margin-top: 30px">
		<br/><h3>회원목록</h3>
		<div class="list">
			<button class="btn btn-dark" style = "float:right" onClick="register();">등록</button>
		</div>
...
<div class="modal" id="adminRegister">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form id="registerForm" method="post" action="${root }/user/adminRegister">
					<div class="form-group form-inline justify-content-between">
...
<div class="modal" id="adminModifyInfo">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form id="adminUpdateform" method="post" action="${root }/user/adminUpdate">
					<div class="form-group form-inline justify-content-between">
						<label for="makeId">아이디</label> 
						<input type="text" class="form-control" name="id" id="modifyId" placeholder="아이디" readonly>
						<input type="hidden" class="form-control" name="pwd" id="modifyPwd">
					</div>
					<div class="form-group form-inline justify-content-between">
