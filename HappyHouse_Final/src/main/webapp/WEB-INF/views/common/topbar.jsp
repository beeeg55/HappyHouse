...
$(document).ready(function () {
	...
	$("select[id$='Gugun']").change(function() {// id명이 Gugun으로 끝나는 태그 선택
		$.get("${pageContext.request.contextPath}/search/dong"
	...
	function showMyInfo() {
		$.ajax({
			type : "get", //요청 메소드 방식
			url : "${pageContext.request.contextPath}/user/showDetails",
...
<div id = "top" class="jumbotron text-center" style="margin-bottom: 0">
	<h1 class = "title">Happy House</h1>
	<p class="text-light title" >나만의 주택 검색 플랫폼</p>
	<div align="right">
		<c:choose>
			<c:when test="${sessionScope.id != null}">
				<button type="button" class="btn btn-dark memberInfo"
				...
				<c:if test="${useage==100}">
					<button type="button" class="btn btn-dark memberInfo"
						...
						onclick="location.href='${root}/user/userList'">회원목록</button>
				</c:if>
			</c:when>
			<c:otherwise>
				<button type="button" class="btn btn-dark visiterInfo loadData"
					data-toggle="modal" data-target="#signUp">회원가입</button>
				<button type="button" class="btn btn-light visiterInfo"
...
<div class="modal" id="modifyInfo">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form id="updateform" method="post" action="${root }/user/update">
					<div class="form-group form-inline justify-content-between">
						<label for="makeId">아이디</label> 
						<input type="text" class="form-control" name="userid" id="modifyId" placeholder="아이디" readonly>
					</div>
					<div class="form-group form-inline justify-content-between">
						<label for="makePwd">비밀번호</label>
						<input type="password" class="form-control" name="userpwd" id="modifyPwd" placeholder="비밀번호">
					</div>

					<div class="form-group form-inline justify-content-between">
						<label for="makeName">이름</label> 
						<input type="text" class="form-control" name="username" id="modifyName" placeholder="아이디">
					</div>
					<div class="form-group form-inline justify-content-between">
...
<div class="modal" id="signUp">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form id="signUpForm" method="post" action="${root }/user/register">
					<div class="form-group form-inline justify-content-between">
...
<div class="modal" id="logOut">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form action="${root }/user/logout" method="get" id="logoutForm">
					<div class="form-group form-inline justify-content-between">
				...
				<form action="${root }/user/login" method="post" id="loginForm">
					...
					<div class="form-group form-inline justify-content-between">
						<label for="pwd">비밀번호</label> <input type="password"
							class="form-control" name="userpwd" id="pwd">
					</div>
...
<nav class="navbar navbar-expand-sm navbar-dark" style = "background-color: #e1eef6">
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link text-body"
				href="${root}/search/main"><b>실거래가 조회</b></a></li>
			<li class="nav-item"><a class="nav-link text-body"
				href="${root}/smartsearch/main"><b>스마트 조회</b></a></li>
			<li class="nav-item"><a class="nav-link text-body"
				href="${root}/hospital/main"><b>안심병원/선별진료소</b></a></li>
			<li class="nav-item"><a class="nav-link text-body"
				href="${root}/biz/main"><b>관심지역</b></a></li> <!-- ${root}/03_interest/interest.jsp -->
			<li class="nav-item"><a class="nav-link text-body"
				href="${root}/notice/main"><b>공지사항</b></a></li>
				<li class="nav-item"><a class="nav-link text-body"
				href="${root}/sitemap/main"><b>사이트맵</b></a></li>
		</ul>
	</div>
</nav>